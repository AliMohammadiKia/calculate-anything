...
dayLabelText.classList = "block text-sm font-semibold text-gray-500 uppercase mb-2 tracking-widest";
...
dayInput.classList = "day-input w-full p-2 border border-gray-300 placeholder-gray-500 rounded-lg text-xl font-bold focus:outline-none focus:border-purple-600";
...
monthLabelText.classList = "block text-sm font-semibold text-gray-500 uppercase mb-2 tracking-widest";
...
monthInput.classList = "month-input w-full p-2 border border-gray-300 placeholder-gray-500 rounded-lg text-xl font-bold focus:outline-none focus:border-purple-600";
...
yearLabelText.classList = "block text-sm font-semibold text-gray-500 uppercase mb-2 tracking-widest";
...
yearInput.classList = "year-input w-full p-2 border border-gray-300 placeholder-gray-500 rounded-lg text-xl font-bold focus:outline-none focus:border-purple-600";
